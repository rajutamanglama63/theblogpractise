                ...
                <div className="home_content">
                    <div className="left">
                        <Paper className={classes.paper}>
                            ...
                            <h1>Nepal literature festival</h1>
                            <img style={{margin : "1rem 0"}} src="https://images.pexels.com/photos/4590202/pexels-photo-4590202.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" />
                            <span>18 july, 2021</span>
                            <p className={classes.rightParagraph}>Lorem Ipsum is simply dummy text of the printing and 
                                typesetting industry.Lorem Ipsum has been the industry's 
                                standard dummy text ever since the 1500s, when an unknown 
