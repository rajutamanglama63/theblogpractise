                    ...
                    <div className="left">
                        <Paper className={classes.paper}>
                            <Link to="/detail" className="link">
                                <h1>Samsung lunch its new phone in nepal.</h1>
                            </Link>
                            <img style={{margin : "1rem 0"}} src="https://images.pexels.com/photos/1092644/pexels-photo-1092644.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" />
