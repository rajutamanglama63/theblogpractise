                    ...
                    <div className="left">
                        <Paper className={classes.paper}>
                            <Link to="/detail" className="link">
                                <h1>CPN moist faction claim PM kp oli as currupted.</h1>
                            </Link>
                            <img style={{margin : "1rem 0"}} src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.xPxWJcB8l1vzEGGWM2am-wHaEK%26pid%3DApi&f=1" />
