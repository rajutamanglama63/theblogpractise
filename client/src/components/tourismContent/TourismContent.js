                    ...
                    <div className="left">
                        <Paper className={classes.paper}>
                            <Link to="/detail" className="link">
                                <h1>About 50,000 tourist visit mustang last year.</h1>
                            </Link>
                            <img style={{margin : "1rem 0"}} src="https://images.pexels.com/photos/3352873/pexels-photo-3352873.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" />
