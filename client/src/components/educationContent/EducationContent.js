                    ...
                    <div className="left">
                        <Paper className={classes.paper}>
                            <Link to="/detail" className="link">
                                <h1>Nepal's education ministry has taken action against education mafia.</h1>
                            </Link>
                            <img style={{margin : "1rem 0"}} src="https://images.pexels.com/photos/3184317/pexels-photo-3184317.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" />
